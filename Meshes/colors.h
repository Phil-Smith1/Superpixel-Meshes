...
std::vector<Scalar> Colors = { Lime, Orange, Gray, Cyan, Yellow, Red, Green, Olive, Magenta, Teal, Silver, Coral, Salmon, Khaki, Plum, orchid, beige, lavender, mocassin, honeydew, ivory, azure, crimson, gold, sky_Blue, aqua_marine, bisque, peach_puff, corn_silk, wheat, violet, lawn_green};
